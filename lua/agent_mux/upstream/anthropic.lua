...
if DEFAULT_API_KEY == "" then DEFAULT_API_KEY = nil end
...
function _M.call(model, messages, tools, opts)
    ...
    local api_key = (opts.api_key and opts.api_key ~= "") and opts.api_key or DEFAULT_API_KEY
